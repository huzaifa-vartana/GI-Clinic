...
public class AdminHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
            ...
            CFAlertDialog.Builder builder = new CFAlertDialog.Builder(this)
                    ...
                    .addButton("Watch Tutorial", -1, -1, CFAlertDialog.CFAlertActionStyle.POSITIVE, CFAlertDialog.CFAlertActionAlignment.JUSTIFIED, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(AdminHome.this.getApplicationContext(), "Loading video", 0).show();
...
// Show the alert
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.bookView) {
            ...
            Intent intent = new Intent(getApplicationContext(), AdminDoctorAvailable.class);
            startActivity(intent);
        } else if (v.getId() == R.id.cancelView) {
            Intent intent = new Intent(getApplicationContext(), AdminCancelApp.class);
            startActivity(intent);
        } else if (v.getId() == R.id.updatesView) {
            Intent intent = new Intent(getApplicationContext(), AdminUpdates.class);
            startActivity(intent);
        }
